...
def parse_args_maddpg():
    ...
    parser.add_argument("--max-episode-len", type=int, default=100, help="maximum episode length") #从25改为10
    parser.add_argument("--num-episodes", type=int, default=500, help="number of episodes") #从60000改为100
    ...
    parser.add_argument("--batch-size", type=int, default=32, help="number of episodes to optimize at the same time") #从1024改为32
    ...
    parser.add_argument("--save-rate", type = int, default = 1,
                        help="save model once every time this many episodes are completed") #从1000改为10
    ...
    parser.add_argument("--benchmark-iters", type=int, default=10, help="number of iterations run for benchmarking") #将100000改为10
